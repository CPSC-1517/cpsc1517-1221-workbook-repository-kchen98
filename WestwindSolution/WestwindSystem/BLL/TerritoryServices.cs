...
namespace WestwindSystem.BLL
{
    public class TerritoryServices
    {
        ...
        public List<Territory> List(int pageNumber, int pageSize, out int totalCount)
        {
        ...
        public List<Territory> FindByRegionId(int regionId, int pageNumber, int pageSize, out int totalCount)
        {
            var query = _dbContext
                .Territories
        ...
        public List<Territory> FindByPartialName(string partialName, int pageNumber, int pageSize, out int totalCount)
        {
            var query = _dbContext
                .Territories
